...
export const en = {
  // General UI
  "EI Scale Calculator": "Dual Index Calculator",
  ...
  "EI Index": "EI Index",
  "Practicality Index": "Practicality Index",
  ...
  "The instrumentation score is based on the energy consumption (100-75 points) as the base score, with adjustments for vapor emissions (-20), manual methods (-5), non-multianalyte methods (-5), and miniaturized instruments (+10). The overall score cannot exceed 100.": "The instrumentation score is based on the energy consumption (100-75 points) as the base score, with adjustments for vapor emissions (-20), manual methods (-5), non-multianalyte methods (-5), and miniaturized instruments (+10). The overall score cannot exceed 100.",
  
  // Practicality Form
  "About Practicality Index": "About Practicality Index",
  "The Practicality Index (PI) accounts for 50% of the total Dual Index Calculator. It measures the real-world applicability and efficiency of an analytical method.": "The Practicality Index (PI) accounts for 50% of the total Dual Index Calculator. It measures the real-world applicability and efficiency of an analytical method.",
  "Please fill in the information below to calculate your Practicality Index (PI).": "Please fill in the information below to calculate your Practicality Index (PI).",
  ...
  "Red": "Red",
  "Practicality score PI": "Practicality score PI",
  "Excellent Practicality – Highly applicable and efficient": "Excellent Practicality – Highly applicable and efficient",
  "Dark Blue": "Dark Blue",
  "Acceptable Practicality – Viable with moderate optimization": "Acceptable Practicality – Viable with moderate optimization",
